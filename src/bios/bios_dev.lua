...
if dev then
	...
	--REMOVE_START
	if gui and getComponent("gpu").maxDepth() ~= nil then --have to be removed to get the minified version small enough to fit on a eeprom
		local orgPrint = print
		...
		print = function(msg)
			...
			gpu.set(1, resY, "[BIOS]: " .. msg .. string.rep(" ", resX))
		end
	end
	--REMOVE_END
end
